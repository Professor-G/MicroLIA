...
class Test(unittest.TestCase):
    def test_compute_statistics(value):
        value.assertEqual( sc.compute_statistics(mag, magerr), (0.70346613225989629, 27.905462817947186,
                          -5.0100150397808205, 1.080251522752754, 1423.3576640580793, 0.36144175147524155, 1, 1, 0.952513966480447,
                          0.036312849162011177, 0.0086303068969277325, 0.0, 0.12967701108376908), "Statistics array incorrect" )
