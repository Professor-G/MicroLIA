...
class Test(unittest.TestCase):
    ...
    def test_kurtosis(value):
        value.assertEqual( sc.kurtosis(mag), -1.0149598629254664, "Kurtosis function failed" )
    ...
    def test_compute_statistics(value):
        value.assertEqual( sc.compute_statistics(mjd, mag, magerr), (0.6923076923076923, 1.0, 1.0, 0.3076923076923077, 
                          0.0, 0.0, 0.1868991393928264, 0.64699834923516031, 0.38896680691912117, -1.0149598629254664,
                          0.5, 159412.78061393721, 1.5, 0.02696060251569303, 0.5384615384615384, 18.661538461538463), "Statistics array incorrect" )
