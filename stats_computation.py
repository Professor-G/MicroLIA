...
def compute_statistics(time, mag, magerr):
    ...
    following order: BelowMeanBySTD_1, BelowMeanBySTD_3, BelowMeanBySTD_5, AboveMeanBySTD_1, 
    AboveMeanBySTD_3, AboveMeanBySTD_5, skewness, stetsonK, vonNeumannRatio, kurtosis, medianAbsDev, 
    stetsonJ, amplitude, std_over_mean, median_buffer_range, RMS.
