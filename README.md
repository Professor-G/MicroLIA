...
When a lightcurve is flagged as a potential microlensing candidate, a PSPL fit is attempted using the Levenberg-Marquardt algorithm. If the fit fails, another attempt is made using the differential evolution algorithm. For documentation, see: https://ebachelet.github.io/pyLIMA/pyLIMA.microlfits.html.
