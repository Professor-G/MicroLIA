...
When a lightcurve is flagged as a potential microlensing candidate, a PSPL fit is attempted using the Levenberg-Marquardt algorithm. Microlensing parameters (t<sub>o</sub>, u<sub>o, t<sub>E) as well as the reduced chi-squred must fall within reasonable parameters. If the fit fails, another attempt is made using the differential evolution algorithm. For documentation, see: https://ebachelet.github.io/pyLIMA/pyLIMA.microlfits.html.
