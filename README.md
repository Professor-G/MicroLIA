...
```
We’re interested only in the predicted class and the probability it’s microlensing, but in principle you can output all the predictions if you want. More examples, including how to drip-feed your lightcurves into the classifier to visualize performance, are available in the **examples** directory.
