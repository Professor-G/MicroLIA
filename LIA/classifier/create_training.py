...
noise_model = create_noise(median,rms)
    
def create_training(timestamps, min_base=14, max_base=21, fn=None, q=1000):
    """Creates a training dataset.
    Simulates each class q times, adding errs from
    ...
    timestamps : array of arrays
		...
		Must be an array containing all possible timestamps.
    min_base : float
    ...
    training_stats : txt file
		A .txt file with all the features computed.
    """
    if q < 12:
