...
def test_microlensing(timestamps, microlensing_mag, magerr, baseline, u_0, t_0, t_e, blend_ratio):
    ...
    This requires 7 measurements with a magnification of at least 1.34, in
    imposing addition to magnification thresholds. 
    ...
    microlensing_mag = -2.5*np.log10(microlensing_flux)
    err = (2.5/log(10))*(flux_err/flux)
    """
